 ...
 * Download the latest release of the plugin from [GitHub](https://github.com/azurecurve/codepotent-username-protection/releases/latest/).
...
### [Version 1.1.3](https://github.com/azurecurve/azrcrv-widget-announcements/releases/tag/v1.1.3)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.1.2](https://github.com/azurecurve/azrcrv-widget-announcements/releases/tag/v1.1.2)
